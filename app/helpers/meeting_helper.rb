module MeetingHelper
	...
	def self.insert_meeting(new_meeting, user)
		...
		if before_meeting != nil and arriving_travel.duration > (new_meeting.start_date - before_meeting.leaving_travel.end_time)
		...
		if after_meeting != nil and leaving_travel.duration > (after_meeting.arriving_travel.start_time - new_meeting.end_date)
