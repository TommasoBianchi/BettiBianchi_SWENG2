...
class CalendarController < ApplicationController
	...
	# events (meeting + travel + def location) that the user has to do during the day
	def show_day
		@user = current_user
	...
	# This method supports the page that shows the calendar weekly page. It retrieves in the correct order all
	# the meetings that the user has to do during the week
	def show_week
		@user = current_user
	...
	# This method supports the page that shows the calendar monthly page. It retrieves in the correct order all
	# the meetings that the user has to do during the month
	def show_month
		@user = current_user
	...
	# This method retrieves all the events from a specific date to a specific date, given a user
	...
	# This method pushes all the break of a user in the daily schedule
	...
	# This is a support method that checks if an item is in between two bounds
