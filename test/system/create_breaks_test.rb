...
class CreateBreaksTest < ApplicationSystemTestCase
	...
	test "create a break and make it undoable" do
		#Login
		login_test_user
		...
		title = "Test break #{rand(1..100000000)}"
		fill_in "name", with: title
		fill_in "day_of_the_week", with: "Saturday"
		fill_in "start_time_slot", with: "12:00pm"
		fill_in "default_time", with: "1:00pm"
		fill_in "end_time_slot", with: "2:00pm"
		fill_in "duration", with: "30"
		...
		fill_in "title", with: "New Test Meeting"
		fill_in "abstract", with: "abstract"
		fill_in "date", with: (DateTime.new(2018, 1, 6) + 50.weeks).strftime("%Y/%-m/%-d")
		fill_in "start_date", with: "10:00am"
		fill_in "end_date", with: "5:00pm"
		...
		find('.default-location-name', :text => title)
	end
