class AddForeignKeysToMeetingTravelsLocations < ActiveRecord::Migration[5.1]
  def change
    ...
    add_column :travels, :meeting_participation_id, :integer
    add_foreign_key :travels, :meeting_participations

    add_column :travel_steps, :travel_id, :integer
