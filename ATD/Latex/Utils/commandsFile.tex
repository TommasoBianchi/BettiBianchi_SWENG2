...
\lfoot{\textcolor{Gray}{\small{Copyright © 2018, \names – All rights reserved}}}
...
\usepackage{enumitem}
\usepackage{amssymb}
\usepackage[listings]{tcolorbox} % for displaying an ubuntu-like black terminal
\usepackage{hyperref}
...
\usepackage{algorithmicx} % algorithm pseudocode
...
\usepackage{longtable} % make tables span over multiple pages
