...
\begin{enumerate}
\item {\textbf{\nameref{sect:introduction}}}: this section contains an overview on the purpose of this document, together with references to the tested project and the related documents.
...
\item {\textbf{\nameref{sect:ux}}}: in this section there is the review we made on the User Experience of the project. We have tried the system extensively navigating all its pages from the point of view of a user.
